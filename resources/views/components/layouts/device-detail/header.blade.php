...
<body class="min-h-screen" x-data x-init="$store.theme.init()">
    <mijnui:header>
        <mijnui:header.navbar>

            <mijnui:icon x-on:click="$store.theme.switchTheme()" class=" p-1 size-8 rounded  cursor-pointer border">
            ...
            <mijnui:icon class="p-1 size-8 rounded hover:bg-gray-200 cursor-pointer border">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
